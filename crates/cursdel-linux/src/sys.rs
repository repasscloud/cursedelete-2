...
//! delete operations.
//!
//! Identical in shape to `cursdel-macos::sys`: basic `open`/`O_NOFOLLOW`
//! and fd-ownership handling is standard POSIX and behaves the same on
//! Linux and Darwin. Nothing in this file is Linux-specific.
